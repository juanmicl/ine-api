...
def test_get_operacion_hits_path_with_id():
    ...
    ops = Client().operaciones.get("IPC")
    assert route.called
...
def test_get_operacion_forwards_det_param():
    ...
    Client().operaciones.get("IPC", det="2")
...
def test_get_operacion_raw_returns_dict():
    ...
    data = Client().operaciones.get("IPC", raw=True)
...
def test_get_datos_serie_hits_path_with_id():
    ...
    series = Client().datos.serie("CP0222024")
    assert route.called
...
def test_get_datos_serie_forwards_scalar_params():
    ...
    Client().datos.serie("CP0222024", nult=12, det="1", tip="AM")
...
def test_get_datos_serie_forwards_date_as_repeated_query():
    ...
    Client().datos.serie("CP0222024", date=["20200101:20201231", "20210101:20211231"])
...
def test_get_datos_serie_raw():
    ...
    data = Client().datos.serie("CP0222024", raw=True)
    assert data == [{"Data": []}]
...
def test_get_datos_metadataoperacion_hits_path_with_op():
    ...
    series = Client().datos.metadata_operacion("IPC", nult=1)
    assert route.called
    assert isinstance(series[0], DatosSerie)
...
def test_get_datos_metadataoperacion_no_filtros_means_no_g():
    ...
    Client().datos.metadata_operacion("IPC")
...
def test_get_datos_metadataoperacion_raw():
    ...
    data = Client().datos.metadata_operacion("IPC", raw=True)
    assert data == [{"Data": []}]
